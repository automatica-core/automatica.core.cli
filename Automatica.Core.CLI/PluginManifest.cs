...
namespace Automatica.Core.CLI
{
    ...
    public class PluginManfiestData
    {
        ...
        {
            get => AutomaticaVersion.FromVersion(ManifestVersion);
        ...
        {
            get => AutomaticaVersion.FromVersion(PluginVersion);
        ...
        {
            get => AutomaticaVersion.FromVersion(MinCoreServerVersion);
